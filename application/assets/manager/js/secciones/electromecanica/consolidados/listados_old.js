...
function initDatatable(search = false, type = 0) {
  ...
  var table = $("#consolidados_dt").DataTable({
      ...
      columnDefs: [
        ...
        { targets: [3], title: "Nro factura", data: 1, orderable: false },
        { targets: [4], title: "Nro cuenta", data: 2, width: "20px", orderable: false },
        { targets: [5], title: "Medidor", data: 3, orderable: false },
        {
            targets: [6], // Dependencia
            title: "Dependencia",
            data: 4,
            orderable: false,
        ...
        { targets: [8], title: "Nombre Cliente", data: 6, orderable: false }, //1-2-3
        { targets: [9], title: "Cons kWh/kW", data: 7, orderable: false }, //1-2
        { targets: [10], title: "Cosfi", data: 9, orderable: false }, //1-2
        { targets: [11], title: "Tgfi", data: 10, orderable: false }, //3
        { targets: [12], title: "E Activa kWh", data: 53, orderable: false },
        { targets: [13], title: "E Reactiva kVArh", data: 54, orderable: false },
        { targets: [14], title: "Importe $", data: 11, orderable: false },
        { targets: [15], title: "Vencimiento", data: 14, orderable: false },
        { targets: [16], title: "Impuestos $", data: 15, orderable: false },
        { targets: [17], title: "Bimestre", data: 16, orderable: false },
        { targets: [18], title: "Liquidación", data: 17, orderable: false },
        { targets: [19], title: "P Contr Kw", data: 56, orderable: false },
        { targets: [20], title: "Cargo Fijo $", data: 19, orderable: false },
        { targets: [21], title: "Cargo Var $", data: 20, orderable: false },
        { targets: [22], title: "Cargo Var > $", data: 21, orderable: false },
        { targets: [23], title: "Otros Conceptos $", data: 22, orderable: false },
        { targets: [24], title: "Conceptos Eléctricos $", data: 23, orderable: false },
        { targets: [25], title: "Energía Inyectada", data: 24, orderable: false },
        { targets: [26], title: "Pot Punta", data: 25, orderable: false },
        { targets: [27], title: "Pot Fuera Punta Cons", data: 26, orderable: false },
        { targets: [28], title: "Energía Punta Act", data: 27, orderable: false },
        { targets: [29], title: "Energía Resto Act", data: 28, orderable: false },
        { targets: [30], title: "Energía Valle Act", data: 29, orderable: false },
        { targets: [31], title: "Energía Reac Act", data: 30, orderable: false },
        { targets: [32], title: "Cargo Pot Contratada $", data: 31, visible: false, orderable: false },
        { targets: [33], title: "Cargo Pot Ad $", data: 32, visible: false, orderable: false },
        { targets: [34], title: "Cargo Pot Excedente $", data: 33, visible: false, orderable: false },
        { targets: [35], title: "Recargo TGFI $", data: 34, orderable: false },
        { targets: [36], title: "Consumo Pico Vigente", data: 35, orderable: false },
        { targets: [37], title: "Cargo Pico $", data: 36, orderable: false },
        { targets: [38], title: "Consumo Resto Vigente", data: 37, orderable: false },
        { targets: [39], title: "Cargo Resto $", data: 38, orderable: false },
        { targets: [40], title: "Consumo Valle Vigente", data: 39, visible: false, orderable: false },
        { targets: [41], title: "Cargo Valle $", data: 40, orderable: false },
        { targets: [42], title: "E Actual", data: 41, orderable: false },
        { targets: [43], title: "Cargo Contratado", data: 42, orderable: false },
        { targets: [44], title: "Cargo Adquirida $", data: 43, orderable: false },
        { targets: [45], title: "Cargo Excedente $", data: 44, orderable: false },
        { targets: [46], title: "Cargo Variable $", data: 45, orderable: false },
        { targets: [47], title: "Total Vencido $", data: 46, orderable: false },
        { targets: [48], title: "E Reactiva kVArh", data: 47, orderable: false },
        { targets: [49], title: "P Registrada", data: 57, orderable: false },
        { targets: [50], title: "U.Med", data: 8, visible: false, orderable: false },
        { targets: [51], title: "Días Cons", data: 49, orderable: false },
        { targets: [52], title: "Días Comp", data: 50, orderable: false },
        { targets: [53], title: "Cons DC kWh", data: 51, orderable: false },
        { targets: [54], title: "Período Consumo", data: 52, orderable: false },
        { targets: [55], title: "Mes Fc", data: 12, orderable: false },
        { targets: [56], title: "Año Fc", data: 13, orderable: false },
        { targets: [57], title: "Subsidio", data: 55, orderable: false },
        { targets: [58], title: "Car Var Hasta kw", data: 18, orderable: false },
      ...
      function aplicarVisibilidad() {
        ...
        if (table.columns().count() > 10) { // Verificar que existen al menos 11 columnas
          if (selectedProveedor == '1') {
            //table.column(8).visible(false); //Nombre Cliente
            table.column(11).visible(false);  // Tgfi
            table.column(12).visible(false);   //E Activa kWh
            //table.column(18).visible(false);   //Liquidación
            table.column(19).visible(false);    //P Contr Kw"
            ...
            table.column(57).visible(false); // Cargo Variable Hasta
            table.column(58).visible(false)
