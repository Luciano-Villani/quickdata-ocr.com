<?php if ($this->ion_auth->is_super() || $this->ion_auth->is_admin()) { ?>
	<div class="mia card">
		...
		<div class="row">
			...
			<div class="col-md-1">
				<div class="form-group form-group-feedback form-group-feedback-right">
					<input required type="text" class="form-control campo-agregar" placeholder="Código" name="id_interno"
			...
			<div class="col-md-6">
				<div class="form-group form-group-feedback form-group-feedback-right">
					<input required type="text" class="form-control campo-agregar" placeholder="Descripción del Programa" name="descripcion"
						value="<?php //echo set_value('rafam'); ?>">
					<div class="form-control-feedback">
						<i class=" icon-pencil3 text-muted"></i>
					</div>
