...
-->
		<?php echo form_open(base_url('Admin/Programas/agregar'), "id='myProgramForm'"); ?>
		<div class="row">
			<div class="col-md-4">
				<div class="form-group form-group-feedback form-group-feedback-right">
					...
					<?= form_dropdown('id_secretaria', $select_secretarias, set_value('secretaria'), $js); ?>
			...
			<div class="col-md-4">
				<div class="form-group form-group-feedback form-group-feedback-right">
					...
					<?= form_dropdown('id_dependencia', '', set_value('ddependencia'), $js); ?>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group form-group-feedback form-group-feedback-right">
					<input type="text" class="form-control" placeholder="Nombre Programa" name="descripcion"
						value="<?php //echo set_value('rafam'); ?>">
					<div class="form-control-feedback">
						<i class=" icon-pencil3 text-muted"></i>
					</div>
