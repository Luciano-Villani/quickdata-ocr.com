...
public function get_seguimiento_proveedores_canon_list()
{
    // 1. SELECT y ORDER BY
 ...
 */
public function get_seguimiento_proveedores_canon_count()
{
    ...
    return $this->db->count_all_results('_consolidados_canon'); 
}
}
