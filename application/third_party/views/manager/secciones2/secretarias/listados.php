		...
		<div class="card-header header-elements-inline">
			...
			<div class="header-elements">
				...
				<div class="text-right">
					<button type="submit" class="acciones btn bg-teal-400 ">Agregar Secretaría <a id="altaSecretaria" class="list-icons-item" data-action="collapse"></a></button>
				</div>
...
-->
			...
			<button type="submit" class="btn bg-teal-400 btn-labeled btn-labeled-right"><b><i class="icon-plus3"></i></b>Agregar</button>
			<?= form_close(); ?>
		</div>
	</div>
<?php } ?>
<div class="card">
	<div class="card-header header-elements-inline">
		<h5 class="card-title">Lista de Secretarías</h5>
