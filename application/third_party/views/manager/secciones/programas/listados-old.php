...
<div class="card">
	<div class="card-header header-elements-inline">
		<h5 class="card-title">
			Agregar <?= ucfirst($this->router->fetch_class()) ?>
		</h5>
...
-->
		<?php echo form_open(base_url('Admin/Programas'), "id='myProgramForm'"); ?>
		<div class="row">
			<div class="col-md-4">
...
<div class="card">
	<div class="card-header header-elements-inline">
		<h5 class="card-title"><?= ucfirst($this->router->fetch_class()) ?> en tabla</h5>
