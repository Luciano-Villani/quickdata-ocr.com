    ...
    <header class="wrapper bg-gray">
      <nav class="navbar center-nav transparent navbar-expand-lg navbar-light">
        <div class="container flex-lg-row flex-nowrap align-items-center">
          <div class="navbar-brand w-100"><a href="start.html"><img src="<?= web_assets(); ?>img/logo.png" srcset="<?= web_assets(); ?>img/logo@2x.png 2x" alt="" /></a></div>
          <div class="navbar-collapse offcanvas-nav">
            <div class="offcanvas-header d-lg-none d-xl-none">
              <a href="start.html"><img src="<?= web_assets(); ?>img/logo-light.png" srcset="<?= web_assets(); ?>img/logo-light@2x.png 2x" alt="" /></a>
          ...
          <div class="navbar-other w-100 d-flex ms-auto">
            <ul class="navbar-nav flex-row align-items-center ms-auto" data-sm-skip="true">
              ...
              <li class="nav-item d-none d-md-block">
                <a href="/Admin" class="btn btn-sm btn-primary rounded-pill">Manager</a>
              </li>
        ...
        <div class="container pt-10 pt-md-14 pb-14 pb-md-17 text-center">
          <div class="row text-center">
            <div class="col-lg-9 col-xxl-7 mx-auto" data-cues="zoomIn" data-group="welcome" data-interval="-200">
              ...
              <?php echo back_assets();
              // echo web_assets();
              // echo '<pre>';
              // var_dump( $this->config->item('front_assets')); 
              // echo '</pre>';
              // die();
              ?>
              </h2>
          ...
          <div class="row text-center mt-10">
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
              <figure><img class="w-auto" src="<?= web_assets(); ?>img/concept/concept8.png" srcset="<?= web_assets(); ?>img/concept/concept8@2x.png 2x" alt="" /></figure>
            </div>
            <!-- /column -->
          </div>
          <!-- /.row -->
        ...
        <div class="container py-14 py-md-17">
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center">
            <div class="col-md-6 col-lg-3">
              <img src="<?= web_assets(); ?>img/icons/megaphone.svg" class="svg-inject icon-svg icon-svg-md text-blue mb-3" alt="" />
              <h4>Marketing</h4>
            ...
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="<?= web_assets(); ?>img/icons/target.svg" class="svg-inject icon-svg icon-svg-md text-green mb-3" alt="" />
              <h4>Strategy</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="<?= web_assets(); ?>img/icons/settings-3.svg" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
              <h4>Development</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="<?= web_assets(); ?>img/icons/bar-chart.svg" class="svg-inject icon-svg icon-svg-md text-orange mb-3" alt="" />
              <h4>Data Analysis</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
      ...
      <div class="wrapper bg-gray">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
            <div class="col-lg-7">
              <figure><img class="w-auto" src="<?= web_assets(); ?>img/concept/concept3.png" srcset="<?= web_assets(); ?>img/concept/concept3@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
              ...
              <div class="d-flex flex-row mb-4">
                <div>
                  <img src="<?= web_assets(); ?>img/icons/light-bulb.svg" class="svg-inject icon-svg icon-svg-sm text-blue me-4" alt="" />
                </div>
                <div>
              ...
              <div class="d-flex flex-row mb-4">
                <div>
                  <img src="<?= web_assets();?>img/icons/pie-chart-2.svg" class="svg-inject icon-svg icon-svg-sm text-green me-4" alt="" />
                </div>
                <div>
              ...
              <div class="d-flex flex-row">
                <div>
                  <img src="<?= web_assets();?>img/icons/design.svg" class="svg-inject icon-svg icon-svg-sm text-yellow me-4" alt="" />
                </div>
                <div>
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-7 order-lg-2">
              <figure><img class="w-auto" src="<?= web_assets();?>img/concept/concept2.png" srcset="<?= web_assets();?>img/concept/concept2@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <div class="col-lg-8">
              <div class="carousel owl-carousel text-center" data-margin="30" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "2"}, "1200":{"items": "3"}}'>
                <div class="item">
                  <img class="rounded-circle w-20 mx-auto mb-4" src="<?= web_assets();?>img/avatars/t1.jpg" srcset="<?= web_assets();?>img/avatars/t1@2x.jpg 2x" alt="" />
                ...
                <!-- /.item -->
                <div class="item">
                  <img class="rounded-circle w-20 mx-auto mb-4" src="<?= web_assets(); ?>img/avatars/t2.jpg" srcset="<?= web_assets(); ?>img/avatars/t2@2x.jpg 2x" alt="" />
                ...
                <!-- /.item -->
                <div class="item">
                  <img class="rounded-circle w-20 mx-auto mb-4" src="<?= web_assets(); ?>img/avatars/t3.jpg" srcset="<?= web_assets(); ?>img/avatars/t3@2x.jpg 2x" alt="" />
                ...
                <!-- /.item -->
                <div class="item">
                  <img class="rounded-circle w-20 mx-auto mb-4" src="<?= web_assets(); ?>img/avatars/t4.jpg" srcset="<?= web_assets(); ?>img/avatars/t4@2x.jpg 2x" alt="" />
                ...
                <!-- /.item -->
                <div class="item">
                  <img class="rounded-circle w-20 mx-auto mb-4" src="<?= web_assets(); ?>img/avatars/t5.jpg" srcset="<?= web_assets(); ?>img/avatars/t5@2x.jpg 2x" alt="" />
      ...
      <div class="wrapper bg-gray">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-6 mb-15 align-items-center">
            <div class="col-lg-7 order-lg-2">
              <figure><img class="w-auto" src="<?= web_assets(); ?>img/concept/concept4.png" srcset="<?= web_assets(); ?>img/concept/concept4@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
          ...
          <div class="px-lg-5">
            <div class="row gx-0 gx-md-8 gx-xl-12 gy-8 align-items-center">
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c1.png" alt="" /></figure>
              </div>
              <!--/column -->
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c2.png" alt="" /></figure>
              </div>
              <!--/column -->
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c3.png" alt="" /></figure>
              </div>
              <!--/column -->
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c4.png" alt="" /></figure>
              </div>
              <!--/column -->
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c5.png" alt="" /></figure>
              </div>
              <!--/column -->
              <div class="col-4 col-md-2">
                <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="<?= web_assets(); ?>img/brands/c6.png" alt="" /></figure>
              </div>
              <!--/column -->
            </div>
            <!--/.row -->
    ...
    <section id="contact">
      <div class="wrapper bg-light">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-7">
              <figure><img class="w-auto" src="<?= web_assets(); ?>img/concept/concept5.png" srcset="<?= web_assets(); ?>img/concept/concept5@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
    ...
    <div class="container py-13 py-md-15">
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            <img class="mb-4" src="<?= web_assets(); ?>img/logo-light.png" srcset="<?= web_assets(); ?>img/logo-light@2x.png 2x" alt="" />
