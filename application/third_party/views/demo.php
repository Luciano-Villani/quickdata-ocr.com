...
<head>
	...
	<title>QuickData- MVL</title>

	<!-- Global stylesheets -->
	<link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">

	<link href="http://manager.local/assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css">
	<link href="http://manager.local/assets/css/minified/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="http://manager.local/assets/css/minified/core.min.css" rel="stylesheet" type="text/css">
	<link href="http://manager.local/assets/css/minified/components.min.css" rel="stylesheet" type="text/css">
	<link href="http://manager.local/assets/css/minified/colors.min.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->

	<!-- Core JS files -->
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/loaders/pace.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/core/libraries/jquery.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/core/libraries/bootstrap.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/loaders/blockui.min.js"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="http://manager.local/assets/js/plugins/pickers/daterangepicker.js"></script>

	<script type="text/javascript" src="http://manager.local/assets/js/core/app.js"></script>
	<!-- /theme JS files -->
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html"><img src="assets/images/logo-mvl.png" alt="" style="width: 98px; height: 28px; padding-bottom: 8px;"></a>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					...
					<ul class="dropdown-menu">
						<li><a class="espana"><img src="assets/images/flags/es.png" alt=""> Español</a></li>
				...
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="#"><span class="badge bg-teal-400 pull-right">58</span> <i class="icon-comment-discussion"></i> Mesages</a></li>-->
						<li class="divider"></li>
						<li><a href="#"><i class="icon-cog5"></i> Configurar Cuenta</a></li>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> &nbsp;Vicente López, BA
									</div>
								</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- datos -->
								<li class="navigation-header"><span>Datos</span> <i class="icon-menu" title="Datos"></i></li>
								
								<li>
									<li class="active"><a href="index.html"><i class="icon-grid7"></i> <span>Datos Consolidados</span></a></li>
									<li><a href="index.html"><i class="icon-upload"></i> <span>Datos leidos OCR</span></a></li>
								</li>
								<!--<li>
								...
								<li class="navigation-header"><span>Estructura programática</span> <i class="icon-menu" title="Estructura programática"></i></li>
								<li><a href="index.html"><i class="icon-office"></i> <span>Secretarías</span></a></li>
								<li><a href="index.html"><i class="icon-store"></i> <span>Dependencias</span></a></li>
								<li><a href="index.html"><i class="icon-newspaper"></i> <span>Programas</span></a></li>
								<li><a href="index.html"><i class="icon-pen"></i> <span>Proyectos</span></a></li>
								<li><a href="index.html"><i class="icon-construction"></i> <span>Obras</span></a></li>
								<!-- /estructura programatica -->

								<!-- Index table -->
								<li class="navigation-header"><span>Relaciones Juridiscion-Proveedor</span> <i class="icon-menu" title="Relaciones Juridiscion-Proveedor"></i></li>
								<li><a href="index.html"><i class="icon-database"></i> <span>Indexaciones</span></a></li>
																
								<!-- /indes table -->
								<!-- Proveedores -->
								<li class="navigation-header"><span>Proveedores</span> <i class="icon-menu" title="Proveedores"></i></li>
								<li><a href="index.html"><i class="icon-certificate"></i> <span>Lista de Proveedores</span></a></li>
																
								<!-- /proveedores -->
								<!-- usuarios -->
								<li class="navigation-header"><span>Cuentas de Usuarios</span> <i class="icon-menu" title="Cuentas de Usuarios"></i></li>
								<li><a href="index.html"><i class="icon-user-tie"></i> <span>Administradores</span></a></li>
								<li><a href="index.html"><i class="icon-users4"></i> <span>Operadores</span></a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Datos</span> - Tabla Consolidada</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="index.html"><i class="icon-grid7 position-left"></i> Datos</a></li>
				...
				<div class="content">
					...
					<div class="footer text-muted">
						&copy; 2023. <a href="#">QuickData</a> by <a href="http://themeforest.net/user/Kopyov" target="_blank">VisualDigital</a>
					</div>
					<!-- /footer -->
