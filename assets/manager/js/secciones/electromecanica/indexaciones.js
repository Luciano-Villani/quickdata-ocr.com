  ...
  function initDatatablex(search = false, type = 0) {
    ...
    var table = $("#indexaciones_dt").DataTable({
      ...
      ajax: {
        data: {
          type: type,
          table: "_indexaciones_canon",
          data_search: search,
          id_proveedor: prove,
          tipo_pago: tipo_pago,
          periodo_contable: periodo_contable,
        },
        url: "Electromecanica/Indexaciones/list_dt",
        type: "POST",
  ...
  $(document).ready(function () {
    ...
    $("body").on("click", "a.edit_dato", function (e) {
      ...
      $.ajax({
        ...
        url: $("body").data("base_url")+"Electromecanica/Indexaciones/edit",
        success: function (result) {
    ...
    $("#form-validate-jquery").on(
      ...
      function () {
        ...
        $.ajax({
          ...
          url: $("body").data("base_url") + "Electromecanica/Dependencias/get_dependencias",
          success: function (result) {
            var obj = jQuery.parseJSON(result);
