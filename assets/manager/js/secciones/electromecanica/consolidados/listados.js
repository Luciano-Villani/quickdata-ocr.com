...
function initDatatable(search = false, type = 0) {
  ...
  var table = $("#consolidados_dt").DataTable({
      ...
      columnDefs: [
          ...
          { targets: [17], title: "Liquidación", data: 17 },
          { targets: [18], title: "P Contr Kw", data: 56 },
          { targets: [19], title: "Cargo Fijo $", data: 19 },
          { targets: [20], title: "Cargo Var $", data: 20 },
          { targets: [21], title: "Cargo Var > $", data: 21 },
          { targets: [22], title: "Otros Conceptos $", data: 22 },
          { targets: [23], title: "Conceptos Eléctricos $", data: 23 },
          { targets: [24], title: "Energía Inyectada", data: 24 },
          { targets: [25], title: "Pot Punta", data: 25 },
          { targets: [26], title: "Pot Fuera Punta Cons", data: 26 },
          { targets: [27], title: "Energía Punta Act", data: 27 },
          { targets: [28], title: "Energía Resto Act", data: 28 },
          { targets: [29], title: "Energía Valle Act", data: 29 },
          { targets: [30], title: "Energía Reac Act", data: 30 },
          { targets: [31], title: "Cargo Pot Contratada $", data: 31, visible: false },
          { targets: [32], title: "Cargo Pot Ad $", data: 32, visible: false },
          { targets: [33], title: "Cargo Pot Excedente $", data: 33, visible: false },
          { targets: [34], title: "Recargo TGFI $", data: 34 },
          { targets: [35], title: "Consumo Pico Vigente", data: 35 },
          { targets: [36], title: "Cargo Pico $", data: 36 },
          { targets: [37], title: "Consumo Resto Vigente", data: 37 },
          { targets: [38], title: "Cargo Resto $", data: 38 },
          { targets: [39], title: "Consumo Valle Vigente", data: 39, visible: false },
          { targets: [40], title: "Cargo Valle $", data: 40 },
          { targets: [41], title: "E Actual", data: 41 },
          { targets: [42], title: "Cargo Contratado", data: 42 },
          { targets: [43], title: "Cargo Adquirida $", data: 43 },
          { targets: [44], title: "Cargo Excedente $", data: 44 },
          { targets: [45], title: "Cargo Variable $", data: 45 },
          { targets: [46], title: "Total Vencido $", data: 46 },
          { targets: [47], title: "E Reactiva kVArh", data: 47 },
          ...
          { targets: [56], title: "Car Var Hasta kw", data: 18 },
          { targets: [57], data: 57, visible: true, searchable: false }
      ],
      language: {
