$(document).ready(function () {
    ...
    $("body").on("click", "a.borrar_dato", function (e) {
      ...
      dato.append("table", $('body').data("tabla"));
            ...
            confirm: {
              ...
              action: function () {
                $.ajax({
                  ...
                  cache: false,
                  beforeSend: function () {},
                  url: $("body").data("base_url") + "Electromecanica/Dependencias/delete",
      ...
      dom: "Blfrtip",
       buttons: [
        ...
        ajax: {
          data: {
            type: type,
            table: "_dependencias_canon",
            data_search: search,
          },
          url: $("body").data("base_url") + "Electromecanica/Dependencias/list_dt",
          type: "POST",
