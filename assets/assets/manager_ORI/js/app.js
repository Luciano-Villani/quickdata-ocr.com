...
$(document).on('click', 'button.acciones', function (e) {
...
$(document).ready(function () {
  ...
  $("li.nav-item-menu").each(function (index) {
    var clase = $(this).data("seccion");
    if (clase === class_act) {
      $("li[data-seccion=" + clase + "]").addClass("nav-item-open"); //active para el submenu
      //$("ul[data-submenu-title=" + clase + "]").css('display','block'); //active para el submenu
...
//         message: 'Tu session esta por expirar, quieres mantener conectado??',
